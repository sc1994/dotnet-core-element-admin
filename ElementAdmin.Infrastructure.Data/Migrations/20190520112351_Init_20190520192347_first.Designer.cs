...
namespace ElementAdmin.Infrastructure.Data.Migrations
{
    ...
    [Migration("20190520112351_Init_20190520192347_first")]
    partial class Init_20190520192347_first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElementAdmin.Domain.Entity.ElementAdmin.RoleRouteEntity", b =>
                {
                    ...
                    b.Property<long?>("RRRoleId")
                        .HasColumnName("RoleRouteEntity_RRRoleId");

                    b.Property<long?>("RRRouteId")
                        .HasColumnName("RoleRouteEntity_RRRouteId");
            ...
            modelBuilder.Entity("ElementAdmin.Domain.Entity.ElementAdmin.RoleRouteEntity", b =>
                {
                    b.HasOne("ElementAdmin.Domain.Entity.ElementAdmin.RoleEntity", "Role")
                        .WithMany()
                        .HasForeignKey("RRRoleId");

                    b.HasOne("ElementAdmin.Domain.Entity.ElementAdmin.RouteEntity", "Route")
                        .WithMany()
                        .HasForeignKey("RRRouteId");
                });
